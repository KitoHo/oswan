/*
$Date: 2010-05-07 23:30:35 +0900 (Èáë, 07 5 2010) $
$Rev$
*/
    ...
    for (n = 0; n <= len; n++)
    {
        for (i = 0; i <= len; i++)
        {
            ...
            for (y = 0; y < 8; y++)
            {
                ...
                for (x = 0; x < 8; x++)
                {
                    if (name[i] && (font & 0x80)) // ÉXÉyÅ[ÉXÉtÉHÉìÉgÇÕÅ°Ç…Ç»Ç¡ÇƒÇÈÇÃÇ≈ÉXÉLÉbÉv
                    {
                        if (n == i)
                        {
                            *p = 0xFFFF;
